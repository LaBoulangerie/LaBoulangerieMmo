...
public class AbilityArchetype {
    ...
    /**
     * The id of the effect that should be played when using this Ability, see
     * {@link net.laboulangerie.laboulangeriemmo.core.particles.EffectRegistry EffectRegistry}
     */
    public String effect;
    /**
     * A list which contains the required level for each tier of the Ability. This is optional.
     */
    public List<Integer> tiers = new ArrayList<>();

    /**
     * Get the level required for the specified tier or the highest tier if it doesn't exist
     * 
