...
public class KeyStreak {
    ...
    public boolean addKey(ComboKey key, BukkitRunnable timer) {
        ...
        //the parent context should handle creating a new runner that will empty the streak when expired
    ...
    /**
     * Empty the key streak, called when the period between key press is to long, this should be managed by the parent context
     */
    public void fail() {
        keyQueue.clear();
    }
