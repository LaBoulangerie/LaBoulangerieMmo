...
public class DoubleDropLog extends AbilityExecutor {
	...
	public boolean shouldTrigger(Event baseEvent) {
	      ...
	      return block != null && block.getType() == Material.ACACIA_LOG  || block.getType() == Material.BIRCH_LOG || block.getType() == Material.DARK_OAK_LOG || block.getType() == Material.JUNGLE_LOG || block.getType() == Material.OAK_LOG || block.getType() == Material.SPRUCE_LOG || block.getType() == Material.CRIMSON_STEM || block.getType() == Material.WARPED_STEM;
	}
